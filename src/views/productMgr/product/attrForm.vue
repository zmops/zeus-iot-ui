  ...
  <div class="form-content">
    <div class="dialog-body">
      <el-form ref="attrForm" :rules="attrRules" :model="form" label-width="80px" label-position="top" class="dialog-form">
        ...
        <el-form-item v-if="form.source === '18'" label="来源属性" prop="depAttrId">
        ...
        <el-form-item v-if="form.valueType == '3' || form.valueType == '0'" label="单位">
          <el-select v-model="form.units" filterable size="mini" placeholder="请选择单位">
            <el-option-group
...
<script>
import { getValueMapList, getAttrTrapperByPage, createAttrTrapper, updateAttrTrapper, detailAttrTrapper } from '@/api/porductMgr'
